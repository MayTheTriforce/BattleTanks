...
BattleTanks-Linux-Debug:
	 $(PROJECTBUILD) BattleTanks Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanks-Linux-DebugGame:
	 $(PROJECTBUILD) BattleTanks Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanks-Linux-Shipping:
	 $(PROJECTBUILD) BattleTanks Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanks-Linux-Test:
	 $(PROJECTBUILD) BattleTanks Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanks:
	 $(PROJECTBUILD) BattleTanks Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanksEditor-Linux-Debug:
	 $(PROJECTBUILD) BattleTanksEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanksEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BattleTanksEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanksEditor-Linux-Shipping:
	 $(PROJECTBUILD) BattleTanksEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanksEditor-Linux-Test:
	 $(PROJECTBUILD) BattleTanksEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BattleTanksEditor:
	 $(PROJECTBUILD) BattleTanksEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
